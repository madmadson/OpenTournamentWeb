...
export const CLEAR_PLAYER_GAME_RESULT_ACTION = 'CLEAR_PLAYER_GAME_RESULT_ACTION';
export class ClearPlayerGameResultAction implements Action {

  readonly type = 'CLEAR_PLAYER_GAME_RESULT_ACTION';
  constructor(public payload: TournamentGame) {
  }
}
