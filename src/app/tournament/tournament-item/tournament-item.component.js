...
var TournamentItemComponent = (function () {
    ...
    __decorate([
        core_1.Input()
    ], TournamentItemComponent.prototype, "tournament", void 0);
    TournamentItemComponent = __decorate([
        core_1.Component({
...
exports.TournamentItemComponent = TournamentItemComponent;
